...
int relay = 7;
int sms_air;
int airMin = 100; // ketinggian air min
int airMax = 10; // ketinggian air max
...
void setup()
{
  ...
  updateSerial();
  mySerial.println("AT+CMGS=\"xxxxxxxx\"");//nomor hp yang mau dikirim
  updateSerial();
...
void receivedMessage(){
  ...
  mySerial.println("AT+CMGF=1"); // Configuring TEXT mode
  updateSerial();
  mySerial.println("AT+CMGS=\"xxxxxxxxx\"");//nomor hp yang mau dikirim
  updateSerial();
